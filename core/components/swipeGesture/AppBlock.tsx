...
import { Post } from '@/core/typescript/Post'
  ...
  return (
    <>
      ...
      <Animated.View style={[styles.container, containerZIndex]}>
        ...
        >
          <AnimatedScrollView
            style={[scrollViewStyles, { backgroundColor: 'white' }]}
              ...
              >
                <Animated.View style={thumbnailStyles}>
                  <View style={styles.titleWrapper}>
                    <Text style={[styles.title, { color: post.textStyle === 'dark' ? 'white' : 'black' }]}>{post.title}</Text>

                    <StylePressable className=''>
                      <StyledView className='flex items-center gap-2 flex-row mt-8'>
                        <StyledText className={`
                        font-bold text-[12px]
                        ${post.textStyle === 'dark' ? 'text-white' : 'text-black'}
                        `}>SHOP NOW</StyledText>
                        <AntDesign name='caretright' color={
                          post.textStyle === 'dark' ? 'white' : 'black'
                        } size={10} />
                      </StyledView>
                      <StyledView className={
                        `
                        w-[85px] h-[1px] 
                        ${post.textStyle === 'dark' ? 'bg-white' : 'bg-black'}
                        `
                      } />
                    </StylePressable>
                  </View>
